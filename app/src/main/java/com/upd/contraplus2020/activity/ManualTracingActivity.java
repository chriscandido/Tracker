...
import com.upd.contraplus2020.DashboardActivity;
import com.upd.contraplus2020.R;
import com.upd.contraplus2020.db.UserDBHandler;
import com.upd.contraplus2020.fragment.GoogleMapFragment;
import com.upd.contraplus2020.db.UserDBContactHelper;
...
public class ManualTracingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                datePickerDialog = new DatePickerDialog(ManualTracingActivity.this,
    ...
    private void onClick() {
        google_maps_btn.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent startGoogleMaps = new Intent(ManualTracingActivity.this, GoogleMapFragment.class);
